...
let
  ...
  generationsDirBuilder = {installSystem}: let pkgs_ = import ../installer-pkgs.nix {inherit installSystem pkgs;}; in pkgs_.substituteAll {
  ...
  platform = pkgs.stdenv.hostPlatform.platform;
